...
### actual results
fig_bif(bife, [2 14 18], "figRe_R_30_nt.svg", "", "", 0, 2, colRe, 2.2)
barplotmean(bife, [1 13 17], "hist_bife_N.svg", colN)
barplotmean(bife, [4 16 20], "hist_bife_D.svg", colD)
...
### actual results
fig_bif(bifle, [2 17 22], "figRle_Re.svg", "", "", 0, .6, colRe, 2)
barplotmean(bifle, [1 16 21], "hist_bifle_N.svg", colN)
barplotmean(bifle, [5 20 25], "hist_bifle_D.svg", colD)
...
### actual results
fig_bif(bife_sh, [2 14 18], "figRe_R_sh.svg", "", "", 0, .5, colRe, 2)
barplotmean(bife_sh, [1 13 17], "hist_bife_sh_N.svg", colN)
barplotmean(bife_sh, [4 16 20], "hist_bife_sh_D.svg", colD)
...
### actual results
fig_bif(bifle_sh, [2 17 22], "figRle_sh_Re.svg", "", "", 0, .6, colRe, 2)
barplotmean(bifle_sh, [1 16 21], "hist_bifle_sh_N.svg", colN)
barplotmean(bifle_sh, [5 20 25], "hist_bifle_sh_D.svg", colD)
