...
function eco_CR!(du, u, p, t)
    ...
    # inedible and edile rise in the terminal cell

    du[1] = In1 - rn * u[1] -a1 * u[1] * u[2] / ( b1 + u[1]) - a11 * u[1] * u[3] / ( b11 + u[1]) + dD * u[5] 
    du[2] = f * a1 * u[1] * u[2] / (b1 + u[1]) - a42 * u[2] * u[4] / (1. + a42*h42*u[2] + a43*h43*u[3]) - (d1 + e1) * u[2]- df * u[2]
    du[3] = f * a11 * u[1] * u[3] / (b11 + u[1]) -  a43 * u[3] * u[4] / (1. + a42*h42*u[2]+a43*h43*u[3]) - (d11 + e1) * u[3] - df * u[3]
    du[4] = f * a42 * u[2] * u[4] / (1. + a42*h42*u[2] + a43*h43*u[3]) +  f * a43 * u[3] * u[4] / (1. + a42*h42*u[2] + a43*h43*u[3]) - (d2 + e2) * u[4]
    du[5] = d1 * u[2] + d11 * u[3] + d2 * u[4] -  (dD + e3) * u[5]

    du[6] = In1 - rn * u[6] -a1 * u[6] * u[7] / ( b1 + u[6]) - a11 * u[6] * u[8] / ( b11 + u[6]) + dD * u[10] 
    du[7] = f * a1 * u[6] * u[7] / (b1 + u[6]) - a42 * u[7] * u[9] / (1. + a42*h42*u[7] + a43*h43*u[8]) - (d1 + e1) * u[7] - df * u[7]
    du[8] = f * a11 * u[6] * u[8] / (b11 + u[6]) - a43 * u[8] * u[9] / (1. + a42*h42*u[7] + a43*h43*u[8]) - (d11 + e1) * u[8] - df * u[8]
    du[9] = f * a42 * u[7] * u[9] / (1. + a42*h42*u[7] + a43*h43*u[8]) + f * a43 * u[8] * u[9] / (1. + a42*h42*u[7] + a43*h43*u[8]) - (d2 + e2) * u[9]
    du[10] = d1 * u[7] + d11 * u[8] + d2 * u[9] -  (dD + e3) * u[10]

    du[11] = In1 - rn * u[11] -a1 * u[11] * u[12] / ( b1 + u[11]) - a11 * u[11] * u[13] / ( b11 + u[11]) + dD * u[15] 
    du[12] = f * a1 * u[11] * u[12] / (b1 + u[11]) - a42 * u[12] * u[14] / (1. + a42*h42*u[12] + a43*h43*u[13]) - (d1 + e1) * u[12] - df * u[12]
    du[13] = f * a11 * u[11] * u[13] / (b11 + u[11])  - a43 * u[13] * u[14] / (1. + a42*h42*u[12] + a43*h43*u[13]) - (d11 + e1) * u[13] - df * u[13]
    du[14] = f * a42 * u[12] * u[14] / (1. + a42*h42*u[12] + a43*h43*u[13]) + f * a43 * u[13] * u[14] / (1. + a42*h42*u[12]+a43*h43*u[13]) - (d2 + e2) * u[14]
...
# division by 3 to acount for 3fold increase in water volume
    ...
    du[17] = f * a1 * u[16] * u[17] / (b1 + u[16]) - a42 * u[17] * u[19] / (1. + a42*h42*u[17] + a43*h43*u[18]) - (d1 + e1) * u[17] +df * (u[2] + u[7] + u[12])/3. - df * u[17]
    du[18] = f * a11 * u[16] * u[18] / (b11 + u[16]) - a43 * u[18] * u[19] / (1. + a42*h42*u[17] + a43*h43*u[18]) - (d11 + e1) * u[18] + df * (u[3] + u[8] + u[13])/3. - df * u[18]
    du[19] = f * a42 * u[17] * u[19] / (1. + a42*h42*u[17] + a43*h43*u[18]) + f * a43 * u[18] * u[19] / (1. + a42*h42*u[17]+a43*h43*u[18]) - (d2 + e2) * u[19]
    du[20] = d1 * u[17] + d11 * u[18] + d2 * u[19] -  (dD + e3) * u[20]

    du[21] = In1 - rn * u[21] -a1 * u[21] * u[22] / (b1 + u[21]) - a11 * u[21] * u[23] / ( b11 + u[21]) + dD * u[25] 
    du[22] = f * a1 * u[21] * u[22] / (b1 + u[21]) - a42 * u[22] * u[24] / (1. + a42*h42*u[22]+a43*h43*u[23]) - (d1 + e1) * u[22] + df * u[17]
    du[23] = f * a11 * u[21] * u[23] / (b11 + u[21]) - a43 * u[23] * u[24] / (1. + a42*h42*u[22]+a43*h43*u[23]) - (d11 + e1) * u[23] + df * u[18]
    du[24] = f * a42 * u[22] * u[24] / (1. + a42*h42*u[22] + a43*h43*u[23]) + f * a43 * u[23] * u[24] / (1. + a42*h42*u[22] + a43*h43*u[23]) - (d2 + e2) * u[24]
